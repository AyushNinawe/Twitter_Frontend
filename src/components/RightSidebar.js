          ...
          otherUsers?.map((user) => {
            return (
              <div key={user?._id} className='flex items-center justify-between my-3'>
                <div className='flex'>
                  <div>
                    <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRGmnhf7pg8DmCGk6NHqaAXbO00_jW_Tdawlf11pQ_AR1MDcKOONq8x2YPynAOet9vVL-s&usqp=CAU' alt='img' className='size-20 shrink-0 rounded-full object cover'/>
